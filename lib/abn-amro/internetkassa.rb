...
module AbnAmro
  class Internetkassa
    ...
    PRODUCTION_URL   = "https://internetkassa.abnamro.nl/ncol/prod/orderstandard_utf8.asp"
    TEST_URL         = "https://internetkassa.abnamro.nl/ncol/test/orderstandard_utf8.asp"
